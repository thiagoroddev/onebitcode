  ...
  return (
    <div className="app">
      <h1>Meus Jogos</h1>
      {
        games.map((game) => {
          return (
            <div key={game.id} className="game" style={{border: '1px solid black', padding: '1rem', margin: '10rem'}}>
              <img src={game.coverImage} alt={game.title} className="cover-image" style={{height: '30rem', width: '20rem', objectFit:'cover'}} />
